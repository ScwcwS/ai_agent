...
import com.vs.vsaiagent.app.LoveApp;
...
public class AiController {
     ...
     * @return
     */
    @GetMapping(value = "/love_app/chat_rag/sse",produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    public Flux<String> doChatWithRagSse(String message, String chatId) {
        return loveApp.doChatWithRagSse(message, chatId);
    }
    /**
     * SSE 流式调用 AI 恋爱大师应用
     *
    ...
    public SseEmitter doChatWithManus(String message,String contentText) {
        VsManus vsManus = new VsManus(allTools, dashscopeChatModel);
