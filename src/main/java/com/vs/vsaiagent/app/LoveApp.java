...
import com.vs.vsaiagent.advisor.ReReadingAdvisor;
import com.vs.vsaiagent.chatmemory.FileBasedChatMemory;
import com.vs.vsaiagent.rag.LoveAppContextualQueryAugmenterFactory;
import com.vs.vsaiagent.rag.LoveAppRagCustomAdvisorFactory;
...
public class LoveApp {
    ...
    private static final String SYSTEM_PROMPT = "扮演深耕情感领域的专家林夕。第一次对话时开场向用户表明身份，" +
...
//        String rewrittenMessage = queryRewriter.doQueryRewrite(message);
        Flux<String> content = chatClient
                .prompt()
                .system(SYSTEM_PROMPT  + "如果检索到了文档，请在最后列出检索到的文档内容;如果没有检索到文档，那就根据现有知识回答;")
                // 原查询
//                .user(message)
                // 查询重写
                .user(message)
